<template>
  <div class="product-page">
    <section class="product-heading">
      <div class="container">
        <div class="product-heading-inner">
          <h1>NEW ARRIVALS</h1>
