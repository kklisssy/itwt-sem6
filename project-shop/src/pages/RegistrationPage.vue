      ...
      <div class="container">
        <div class="registration-layout">
          <form class="registration-form" @submit.prevent="handleSubmit">
            ...
            <div class="gender-options" aria-label="Gender">
              <label>
                <input
                  v-model="form.gender"
                  type="radio"
          ...
          <section class="loyalty">
            <h2>{{ userStore.loyalty.title }}</h2>
            <p>
              {{ userStore.loyalty.text }}
            </p>

            <ul>
              <li v-for="string in userStore.loyalty.list" :key="string">
                <svg
                  width="20"
                  height="16"
                  viewBox="0 0 20 16"
...
const handleSubmit = () => {
  userStore.registration(form.value);
};
</script>
...
.registration-layout {
  display: grid;
  grid-template-columns: 360px minmax(0, 652px);
